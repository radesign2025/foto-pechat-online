...
const Quality = () => {
  ...
  return <section id="quality" className="section-container">
      ...
      <div className="max-w-5xl mx-auto">
        <p className="mb-10 text-gray-700 text-justify">Мы печатаем фотографии с особой заботой о качестве! Используем профессиональные шестицветные принтеры Epson и премиальную глянцевую фотобумагу плотностью 230 г/м², чтобы каждая деталь фотографии выглядела безупречно.</p>
        <p className="mb-10 text-gray-700 text-justify"> - Строгий контроль качества.  <br /> - Бесплатная цветокоррекция. <br /> - Высочайшее качество печати.</p> 
        <p className="mb-10 text-gray-700 text-justify">Вашы воспоминания достойны лучшего!</p>
