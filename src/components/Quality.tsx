...
const Quality = () => {
  ...
  return <section id="quality" className="section-container">
      ...
      <div className="max-w-5xl mx-auto">
        <p className="mb-10 text-gray-700 text-left">Мы гарантируем высокое качество печати каждой фотографии. У нас профессиональные шестицветные фото-принтеры Epson. Глянцевую фотобумага плотностью 230 г/м². 

Каждая фотография при необходимости проходит цветокоррекцию, а также обязательный контроль качества после печати.</p>
