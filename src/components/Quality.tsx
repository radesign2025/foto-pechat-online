...
const Quality = () => {
  ...
  return <section id="quality" className="section-container">
      ...
      <div className="max-w-5xl mx-auto">
        <p className="mb-10 text-gray-700 text-left">Мы гарантируем высокое качество печати каждой фотографии. Используем профессиональные шестицветные фото-принтеры Epson и глянцевую фотобумагу 230 г/м².</p>
