...
const Quality = () => {
  ...
  return <section id="quality" className="section-container">
      ...
      <div className="max-w-5xl mx-auto">
        <p className="mb-10 text-gray-700 text-justify my-[15px]">Мы печатаем фотографии с особой заботой о качестве! Используем профессиональные шестицветные принтеры Epson и премиальную глянцевую фотобумагу плотностью 230 г/м², чтобы каждая деталь фотографий выглядела безупречно.</p>
