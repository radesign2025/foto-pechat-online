...
const Quality = () => {
  ...
  return <section id="quality" className="section-container">
      ...
      <div className="max-w-5xl mx-auto">
        <p className="mb-10 text-gray-700 text-justify">Мы используем профессиональные шестицветные фото-принтеры Epson, глянцевую фотобумага плотностью 230 г/м² и гарантируем высокое качество печати каждой фотографии. При необходимости делаем  цветокоррекцию и обязательный контроль качества после печати.</p>
